...
function App() {
  ...
  return (
    <div className="p-5">
      <h3 class="mb-3 p-3 bg-secondary rounded text-white">Calculating alcohol blood level</h3>
      <form onSubmit={handleSubmit} class="p-3 bg-warning rounded">
        <div>
        ...
        <div class="my-4">
          <h4>Your alcohol blood level: {result.toFixed(2)}</h4>
        </div>
